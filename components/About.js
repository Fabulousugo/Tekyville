      ...
      <div className="grid gap-5 row-gap-8 lg:grid-cols-2" >
        <div className="flex flex-col justify-center" >
          <div className="max-w-xl mb-6">
            <h2 className="max-w-lg mb-6 font-sans text-3xl font-bold tracking-tight text-[#007AA3]sm:text-4xl sm:leading-none">
              ...
              <span className="relative px-1">
                ...
                <span className="relative inline-block text-deep-purple-accent-500">
                  a lazy dog
                </span>
              </span>
            </h2>
          ...
          <div className="grid gap-5 row-gap-8 sm:grid-cols-2" >
            <div className="bg-white border-l-4 shadow-sm border-[#007AA3]" style={{backgroundColor:'#000020'}}>
